...
// Récupérer l'ID de la page consultée depuis l'URL
if (isset($_GET['user_id']) && !empty($_GET['user_id'])) {
    ...
    try {
        // Récupérer les informations de l'utilisateur à partir de l'URL
...
// Vérifier si l'utilisateur est abonné (vua = 1 ou vua = 2)
$is_subscribed = ($_SESSION['user']['vua'] == 1 || $_SESSION['user']['vua'] == 2);

// Vérifier si l'utilisateur est hôte (vua = 2)
$is_host = ($_SESSION['user']['vua'] == 2);
?>
	...
	<div class="container">
		...
		<div class="profile">
			...
			<div class="profile-user-settings">
				...
				<a href="message.php?user_id=<?php echo $_SESSION['user']['id']; ?>" class="profile-edit-btn">Discuter</a> 
				<?php if ($is_host): ?>
				<a href="profile.php?user_id=<?php echo $page_id; ?>" class="profile-edit-btn">Modif Admin</a>
				<?php endif; ?>
