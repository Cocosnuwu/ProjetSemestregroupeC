...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    function handlePhotoUpload($photoIndex, $page_id, $db, $upload_dir, $db_upload_dir, $allowed_types, $is_first_photo = false) {
        ...
        if(isset($_FILES[$input_name]) && $_FILES[$input_name]['error'] === UPLOAD_ERR_OK) {
            ...
            if(in_array($file_type, $allowed_types)) {
                ...
                $target_file = $upload_dir . $page_id . '_' . $file_suffix . '.jpg';
                $db_target_file = $db_upload_dir . $page_id . '_' . $file_suffix . '.jpg';
                ...
                if(move_uploaded_file($file_tmp, $target_file)) {
                    ...
                    $query = $db->prepare("UPDATE utilisateur SET $photoField = :photo WHERE id = :page_id");
                    $query->execute(array(':photo' => $db_target_file, ':page_id' => $page_id));
    ...
    handlePhotoUpload(1, $page_id, $db, $upload_dir, $db_upload_dir, $allowed_types, true);
    // Gérer l'upload pour les autres photos
    for ($i = 1; $i <= 8; $i++) {
        handlePhotoUpload($i, $page_id, $db, $upload_dir, $db_upload_dir, $allowed_types);
    }
}
?>
    ...
    <div class="container">
        ...
        <div class="exit-btn">
            <form action="../profile.php" method="get">
                <input type="hidden" name="user_id" value="<?php echo $page_id; ?>">
