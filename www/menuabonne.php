...
<body>
  <header>
      ...
      <ul>
        ...
        <li class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="gestioncompte.php">Gestion de mon compte</a>
            <?php if ($is_subscribed): ?>

              <a href="messagerie.php">Messagerie</a>
              <a href="consultationcompte.php">Consultation du compte</a>
            <?php else: ?>
    ...
    <a class="connexion" href="index.php">Deconnexion</a>
  </header>
</body>
